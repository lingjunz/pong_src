# # /home/lingjunz/anaconda3/envs/pong/lib/python3.6/site-packages/stable_baselines/ppo1/pposgd_simple.py
...
from replace.policies import ActorCriticPolicy
...
class PPO1(ActorCriticRLModel):
    ...
    def __init__(self, policy, env, gamma=0.99, timesteps_per_actorbatch=256, clip_param=0.2, entcoeff=0.01,
                 ...
                 _init_setup_model=True, policy_kwargs=None, full_tensorboard_log=False, save_trajectory = False):
        ...
        with SetVerbosity(self.verbose), TensorboardWriter(self.graph, self.tensorboard_log, tb_log_name, new_tb_log) \
            ...
            with self.sess.as_default():
                ...
                while True:
                    ...
                    obs_ph, hiddens_ph, action_ph, atarg, tdlamret = seg["ob"], seg["hiddens"], seg["ac"], seg["adv"], seg["tdlamret"]
                ...
                if self.save_trajectory:
                    ...
                    trajectory_dic = {
                        ...
                        "all_hiddens":np.vstack(hidden_list).reshape(length,-1),
